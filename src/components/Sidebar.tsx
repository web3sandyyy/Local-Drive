    ...
    <div className="h-screen min-w-[250px] bg-gray-200">
      ...
      <div className="mt-6 ml-4 text-lg flex flex-col shadow-bottom-only overflow-hidden rounded-lg">
        <div
          ...
          className={`relative z-10 cursor-pointer flex gap-2 items-center  hover:bg-gray-100 duration-100 transition-all group border p-4  rounded-lg ${
            showCreate
        ...
        <AnimatePresence>
          {showCreate && (
            <motion.div
              ...
              className="text-base flex flex-col divide-y border p-2 rounded-b-lg overflow-hidden cursor-pointer bg-white"
            >
        ...
        <div className="flex cursor-pointer gap-2 mt-2 items-center bg-white hover:bg-gray-100 duration-100 transition-all group border p-4 rounded-lg">
          <img
            src={upload}
            alt="drive"
